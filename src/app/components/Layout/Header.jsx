    ...
    <>
      ...
      <div className="relative h-full flex justify-center pt-4 lg:pt-40">
        ...
        <img src="/signature.svg" alt="" className=" lg:w-44   mx-auto mb-2 w-24" />
          ...
          <h2 className=" text-base lg:text-xl text-center font-normal mt-4 masked-text mx-2 text-black">I specialize in developing dynamic, user-friendly websites and apps that elevate user experience, optimize performance, and drive business growth.</h2>
